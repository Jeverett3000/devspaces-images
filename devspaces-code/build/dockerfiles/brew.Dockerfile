...
FROM registry.redhat.io/ubi8/nodejs-20:1-74.1746444590 as checode-linux-libc-ubi8-builder
...
FROM registry.redhat.io/ubi9/nodejs-20:9.5-1746604787 as checode-linux-libc-ubi9-builder
# hadolint ignore=DL3002
USER root
...
FROM registry.redhat.io/ubi9/go-toolset:9.5-1747059472 as machineexec-builder
ENV GOPATH=/go/
# hadolint ignore=DL3002
USER root
...
FROM registry.redhat.io/ubi9:9.5-1747112166 AS ubi-builder
...
FROM registry.redhat.io/ubi9-minimal:9.5-1747111267
