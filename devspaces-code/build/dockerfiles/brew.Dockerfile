...
FROM ubi8/nodejs-20:1-71 as checode-linux-libc-ubi8-builder
...
FROM ubi9/nodejs-20:9.5-1734597699 as checode-linux-libc-ubi9-builder
# hadolint ignore=DL3002
USER root
...
FROM rhel8/go-toolset:1.22.9-1 as machineexec-builder
ENV GOPATH=/go/
# hadolint ignore=DL3002
USER root
...
FROM ubi8:8.10-1161 as ubi-builder
