...
FROM registry.redhat.io/ubi8/nodejs-20:1-74.1747183253 as checode-linux-libc-ubi8-builder
...
FROM registry.redhat.io/ubi9/go-toolset:9.6-1747333074 as machineexec-builder
ENV GOPATH=/go/
# hadolint ignore=DL3002
USER root
